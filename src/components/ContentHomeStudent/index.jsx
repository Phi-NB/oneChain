...
import { UserAddOutlined, MenuUnfoldOutlined } from "@ant-design/icons";
...
function ContentHomeStudent(props) {
    ...
    const [colorActiveButtonGrid, setColorActiveButtonGrid] =
        useState("#f0b376");
    ...
    return (
        <div>
            <Header className="site-layout-background">
                <Button
                    className="add-student btnOpenDrawer"
            ...
            <div className="groupsBtn-tranfer-view">
                ...
                <Button
                    ...
                    style={{
                        marginLeft: 20,
                        backgroundColor: colorActiveButtonTable
                    }}
                    type="primary"
                    className="btn_add_up_stu"
                >
